class AppConstants {
  ...
  static const String appSubtitle = 'Security Management System';
  ...
  static const String unknownErrorMessage = 'An unexpected error occurred. Please contact support';
  static const String offlineLoginUnavailable = 'Offline login is only available for security guards';
  static const String noOfflineDataMessage = 'No offline login data found. Please connect to internet to login';
  static const String expiredOfflineDataMessage = 'Offline data has expired. Please connect to internet to continue';
  ...
  static const String deviceNotTrustedMessage = 'This device is not trusted. Please verify your identity';
  static const String locationPermissionMessage = 'Location permission is required for guard duties';
  static const String gpsNotAvailableMessage = 'GPS is not available. Please enable location services';
  ...
  static const String offlineLoginSuccessMessage = 'Logged in using offline mode';
  ...
  static const String movementRecordedMessage = 'Movement recorded successfully';
  ...
  static bool hasAdminPrivileges(String role) {
    return [adminRole, managerRole, supervisorRole].contains(role.toLowerCase());
  }
  ...
  static String getMovementTypeDisplayName(String movementType) {
    switch (movementType.toLowerCase()) {
      ...
      case shiftEndMovement:
        return 'Shift End';
      default:
        return movementType.replaceAll('_', ' ').split(' ')
            .map((word) => word.isNotEmpty ? 
                word[0].toUpperCase() + word.substring(1).toLowerCase() : '')
            .join(' ');
    }
