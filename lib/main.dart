...
void main() {
  runApp(const SlatesAppWear());
}

class SlatesAppWear extends StatelessWidget {
  const SlatesAppWear({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => di.injector<LoginBloc>()..add(LoginEmployeeIdChanged('')),
        ),
      ],
          child: MaterialApp(
        title: 'SlatesApp Wear',
        theme: AppTheme.lightTheme, // Use the theme defined in themes.dart
